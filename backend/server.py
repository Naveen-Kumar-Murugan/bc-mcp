...
class Settings(BaseSettings):
    server_script_path: str = "./main.py"
...
async def connect_to_server():
    ...
    try:
        ...
        success = await client.connect_to_server(settings.server_script_path)
        if success:
...
async def process_query(request: QueryRequest):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"This is error in server.py {str(e)}")
